...
export default function Home() {
  ...
  const launchPostUrl = process.env.NEXT_PUBLIC_LAUNCH_POST_URL || "https://x.com/ese_erigha";
  const githubUrl = process.env.NEXT_PUBLIC_GITHUB_URL || "https://github.com/ese-erigha/youtube-video-transcript";
  const xAccountUrl = process.env.NEXT_PUBLIC_X_ACCOUNT_URL || "https://x.com/ese_erigha";
